export default function Footer() {
    return (
        <footer className="footer bg-[#212121]" >
            <div
                className="brands flex flex-col justify-start items-start gap-4 px-6 py-8 md:px-8 md:py-10 lg:px-16 lg:py-12"
            >
                <h3 className="text-rose-400 font-semibold text-md lg:text-lg">
                    BRAND DIRECTORY
                </h3>
            ...
            <hr/>
            <div
                className="mx-auto flex items-center justify-center flex-col gap-4 py-10 pb-20 lg:pb-10"
            >
                <img alt="payment" className="w-80" src="./assets/images/payment.png"/>
